...
type Props = {
  clinicName?: string;
  /** compact = embedded on home; page = full consult page chrome handled by parent */
  variant?: "home" | "page";
};

export default function QuickIntakeForm({
  clinicName = "HomeClinic",
  variant = "home",
}: Props) {
  ...
  return (
    <>
      <form
        className={`panel stack form-interactive quick-intake ${variant === "home" ? "quick-intake-home" : ""}`}
        onSubmit={onSubmit}
        id="consult-form"
      >
        <div className="quick-intake-grid">
          <label>
            Name *
            <input
              required
        ...
        <label className="checkbox">
          ...
          <span>
            I confirm my information is accurate. I consent to {clinicName} contacting me for a phone
            consultation about this request.
          </span>
        </label>
...
/** Full /consult page wrapper */
export function ConsultPageForm({ clinicName }: { clinicName: string }) {
  return (
    <main>
      ...
      <div className="container page">
        <div className="stack consult-wrap">
          ...
          <QuickIntakeForm clinicName={clinicName} variant="page" />
        </div>
      </div>
    </main>
  );
